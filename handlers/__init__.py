...
from .states import *
from .utils import like_dislike_callback_filter
...
dp.register_callback_query_handler(new_profile_region_callback_handler, lambda callback_query: True,
                                   state=NewProfile.region)
...
dp.register_callback_query_handler(new_filter_role_callback_handler, lambda callback_query: True,
                                   state=NewFilter.role)
